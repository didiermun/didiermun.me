				...
				<div class="mt-12 px-4">
					<div class="font-para text-gray-400 flex flex-col md:flex-row flex-wrap gap-4 pt-2 text-lg">
						...
						<div class="flex gap-1 py-1 self-start">
							...
							<a class="hover:text-[#270082]" target="_blank" href="https://www.linkedin.com/in/didier-munezero-07b849194/">Didier MUNEZERO</a>
						</div>
						<div class="flex gap-1 py-1 self-start">
							...
							<a class="hover:text-[#270082]" target="_blank" href="https://github.com/didiermun">didiermun</a>
						</div>
					</div>
				</div>
			</div>
