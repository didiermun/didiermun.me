...
<section class="w-full">
	<div class="w-full  px-4 flex  flex-col mx-auto items-center justify-center min-h-screen bg-[#141E27]">
		<div class="w-128 flex flex-col items-center">
			<div class="flex justify-center">
				<div class="">
					<div class="w-full px-4 py-4 my-4">
						<p class="font-semibold text-5xl font-para text-center text-gray-400">Hi! I am Didier Munezero.</p>
					</div>
					<div class="">
			...
			<div class="flex justify-center">
				<div>
				<div class="mt-4 px-4">
					<p class="uppercase font-semibold font-para text-[#0C4271]">Connect with me</p>
					<div class="font-para text-gray-400">
